<?php
/**
 * Author: Trent Gaffney
 * URL: northeastern.edu | @neudev
 ...
 */
 ...
 require_once(get_template_directory() . "/functions/rewrite.php");
 ...
 // this should allow logged in users to ONLY see their posts unless they are an administrator
...
function nudev_footer_scripts() {
  //wp_register_script('js-cookie', get_template_directory_uri() . '/_scripts/js/lib/jquery.cookie.js', array('jquery'), '1.0.0'); // Custom scripts
...
add_filter ( 'manage_nualerts_posts_columns', 'add_nualerts_acf_columns' );// Add columns to alerts post listing
add_action ( 'manage_nualerts_posts_custom_column', 'nualerts_custom_column', 10, 2 );// Add columns to alerts post listing
// Remove Filters
